...
$icons = array(
	...
	// A document with a currency mark — an invoice, not a generic circle.
	'invoices'        => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 2h9l4 4v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/><path d="M15 2v5h4"/><path d="M13.2 11.4a2.2 2.2 0 1 0-2.2 3.2 2.2 2.2 0 1 1-2.2 3.2"/><path d="M11 10v9"/></svg>',
