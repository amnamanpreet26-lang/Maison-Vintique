...
function mve_email_settings( $settings ) {
	$ours = array(
		...
		array(
			...
			'desc'        => __( 'Optional. Appears in the dark strip at the bottom of every email.', 'maison-vintique' ),
			'id'          => 'mve_email_address_line',
			'type'        => 'text',
			'default'     => '',
			'css'         => 'min-width:340px;',
			'placeholder' => __( 'Unit 4, Bermondsey Trading Estate, London SE16', 'maison-vintique' ),
		),
		array(
			'title'       => __( 'Telephone shown in the email footer', 'maison-vintique' ),
			'desc'        => '',
			'id'          => 'mve_email_phone',
			'type'        => 'text',
			'default'     => '',
